...
@implementation ZHD_Entity_TopStory
...
- (instancetype) initWithTopStoryDictionary : (NSDictionary *) topStoryDictionary{
    if (topStoryDictionary) {
        ...
        if (self) {
            ...
            _image = topStoryDictionary[@"image"];
            ...
            _topStoryId = [NSNumber numberWithLong:[topStoryDictionary[@"id"] integerValue]];
        }
    }
    return self;
}
...
- (instancetype)init{
    @throw [NSException exceptionWithName:@"Init Error"
                                       reason:@"Use - (instancetype) initWithTopStoryDictionary : (NSDictionary *) topStoryDictionary"
                                     userInfo:nil];
    return nil;
}
...
- (void) encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeObject:_topStoryId forKey:@"topStoryId"];
}
...
- (instancetype) initWithCoder:(NSCoder *)aDecoder{
    ...
    if (self) {
        ...
        [self setTopStoryId:[aDecoder decodeObjectForKey:@"topStoryId"]];
    }
    return self;
}
